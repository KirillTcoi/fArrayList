...
{  
    class Program
    {
        ...
        public static ArrayList music = new ArrayList();
        ...
        public static void VV(ArrayList q)
        {
            Console.WriteLine(q);
        }
        public static void Info(Song s) //Инфа о песне
        {
                Console.Write(Program.nm + ". ");
                Console.WriteLine("{1} - {0} [{2}] ({3}) \r\nРейтинг: {4}/10", s.name, s.group, s.longtime, s.gogod, s.rate);
        }
    }
